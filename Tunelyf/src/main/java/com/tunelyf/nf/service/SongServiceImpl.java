...
import com.tunelyf.nf.repository.GenreRepository;
...
public class SongServiceImpl implements SongService {
    ...
    public List<Song> getAllSongs() {
        return songRepository.findAll(); // or use findByIsHiddenFalse();
    }
    ...
    @Override
    public Song updateSong(Long id, String title, String artist, String genre,
    ...
    public void deleteSong(Long id) {
        ...
        if (song != null) {
            ...
            firebaseStorageService.deleteFileByUrl(song.getUrl());
            firebaseStorageService.deleteFileByUrl(song.getThumbnail());
