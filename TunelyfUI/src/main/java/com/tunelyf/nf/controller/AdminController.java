...
//        if (songs.isEmpty()) {
//            throw new SongNotFoundException("No songs found for genre: " + genreName);
//        }
    ...
    public String showArtists(Model model) {
        List<ArtistDTO> artists = List.of(
            new ArtistDTO("Arijit Singh", "/img/artists/arjit.jpeg"),
            new ArtistDTO("Shreya Ghoshal", "/img/artists/shreya.jpeg"),
            new ArtistDTO("Armaan Malik", "/img/artists/armaan.jpeg"),
            new ArtistDTO("Neha Kakkar", "/img/artists/neha.jpeg"),
            new ArtistDTO("KK", "/img/artists/kk.jpeg"),
            new ArtistDTO("Jubin Nautiyal", "/img/artists/jubin.jpeg")
            // Add more artists as needed
        );

        model.addAttribute("artists", artists);
        model.addAttribute("currentUri", "/admin/artists");
        return "artists"; // maps to artists.html
    }
